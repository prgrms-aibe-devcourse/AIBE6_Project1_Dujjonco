...
import { Star, MapPin, Heart, Accessibility, CircleSlash, BookOpen, DoorOpen, ParkingCircle, Volume2, Users } from "lucide-react";
...
export function Home() {
  ...
  const locations = ["전체", "제주도 서귀포시", "서울 강남구", "부산 해운대구", "강원도 춘천시", "경기도 양평군", "경북 경주시"];
